...
└─────────────┘   
```
The document embedding is a vector representation of the documents, generated by the sentence transformer model and saved in ChromaDB, a [retrieval system](https://docs.trychroma.com/guides/build/intro-to-retrieval).
...
│                                                                               │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐          │
│  │ ChromaDB    │  │  Embedding  │  │ Transformer │  │ Streamlit   │          │
│  │ Vector DB   │  │  Model      │  │ Pipeline    │  │ (Web UI)    │          │
│  │             │  │             │  │ Model       │  │             │          │
│  │             │  │             │  │             │  │             │          │
│  └─────────────┘  └─────────────┘  └─────────────┘  └─────────────┘          │
│                          ┌───────────────┐                                    │
